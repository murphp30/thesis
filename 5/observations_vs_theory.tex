...
\begin{figure}
\centering
\includegraphics[width=\columnwidth]{fwhm_comparison_20220323.png}
...
%Given that changing values for $\varepsilon$ and $\alpha$ still do not bring models and observations in agreement, it is worth considering if type III radio bursts have an intrinsic size. %greater than or equal to the size of a scattered point source
...
\begin{figure}
\centering
\includegraphics[width=\columnwidth]{fwhm_time_comp_20220323.png}
