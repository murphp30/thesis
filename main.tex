...
\documentclass[a4paper,twoside,12pt,usenatbib]{Latex/Classes/PhDthesisPSnPDF}
...
%\usepackage[inner=3.5cm, outer=2cm,top=3.3cm, bottom=2.0cm, footskip=1cm, includeall]{geometry}
\usepackage[bindingmargin=1.5cm, right=2cm, left=2cm, top=2.0cm, bottom=2.0cm, footskip=1.0cm, includeall]{geometry}
...
\include{4/work_chapter_1}
\include{5/work_chapter_2}
